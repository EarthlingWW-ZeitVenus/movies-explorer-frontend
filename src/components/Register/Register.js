    ...
    <section className="register page_format_side-padding">
      ...
      <form className="register__form">
        <fieldset className="register__form-fieldset">
          <label className="register__form-label" for="register-name">Имя</label>
          <input
          ...
          <label className="register__form-label" for="register-email">E-mail</label>
          <input
            className="register__form-input"
                name="register-email"
              ...
              />
          <span className="register__form-input-error"></span>
          <label className="register__form-label" for="register-password">Пароль</label>
          <input
            className="register__form-input"
